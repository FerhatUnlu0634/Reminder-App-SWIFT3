                             ...
                             onError:(void (^)(NSError*)) errorBlock
{
  if(REVIEW_ALLOWED)
  {
    ...
    NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%d/%@", OWN_SERVER, @"featureCheck.php"]];
                         ...
                         onError:(void (^)(NSError*)) errorBlock
{
  ...
  NSURL *url = [NSURL URLWithString:[NSString stringWithFormat:@"%d/%@", OWN_SERVER, @"verifyinapp.php"]];
...
//    NSString *receiptDataString = [self.receipt base64EncodedStringWithOptions:NSDataBase64Encoding64CharacterLineLength];
