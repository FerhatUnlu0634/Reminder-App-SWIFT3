...
- (void)addButtonsToView: (UIView *)container
{
    ...
    NSArray *array_BackImages = @[@"button_Cancel.png", @"button_Done.png"];
    ...
    for (int i=0; i<[buttonTitles count]; i++) {
        ...
        if (appDelegate.EN_Version == YES){
            ...
            CGFloat padding = ([UIScreen mainScreen].bounds.size.height / 667) * 20;
            CGRect rectCancel = CGRectMake((i) * buttonWidth + buttonWidth / 2 - (buttonHeight - padding) / 2,
                                            container.bounds.size.height - buttonHeight + padding / 2,
                                            buttonHeight - padding,
                                            buttonHeight - padding);
            UIImageView *img_Cancel = [[UIImageView alloc] initWithFrame:rectCancel];
            [img_Cancel setImage:[UIImage imageNamed:array_BackImages[i]]];
            [container addSubview:img_Cancel];
        }
